              ...
              <div className="card p-4">
                <div className="card-body">
                  ...
                  <div className="mt-3 login-form">
                    ...
                    <button onClick={facebookSignIn} className="w-100 btn btn-primary social-btn mb-2">
                      <FontAwesomeIcon style={{ marginRight: '5px' }} icon={faFacebook} /><span>Continue With Facebook </span>
                    </button>
                  </div>
